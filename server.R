...
#        width = 4,
 #       checkboxGroupInput("select_occu","Select Up to 5 Occupations", choices = restab()$Title[1:20], inline = FALSE)
  ...
  syllabus_caption_str <- as.character(shiny::tags$h3(style = "color: SteelBlue", "Term frequency of Syllabus (freq >= 5)"))
  jd_caption_str <- as.character(shiny::tags$h3(style = "color: SteelBlue", "Term frequency of Job Descriptions (freq >= 5)"))
